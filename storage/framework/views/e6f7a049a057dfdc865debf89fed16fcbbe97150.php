...
<body>
    ...
    <div class="container">
        ...
        <div class="my-2">
            <a href="<?php echo e(url('images/HYAcademy/Harvestyield-academy-students.pdf')); ?>" download> Download </a>
        </div>
        <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-2">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <a class="mr-5" href="mailto:<?php echo e($student->user->email); ?>"><img class="mr-3"
                                    src="<?php echo e(url('images/icons/message.png')); ?>"
                                    alt="send mail to <?php echo e($student->name); ?>"></a>
                            <a href="tel:<?php echo e($student->phone); ?>"><img src="<?php echo e(url('images/icons/telephone.png')); ?>"
                                    alt="call <?php echo e($student->name); ?>"></a>
                        </div>
                    </div>
                </div>
...
<?php /**PATH D:\Abiodun Samuel\Laravel-Projects\superoinc\resources\views\admin\harvestyield-academy\index.blade.php ENDPATH**/ ?>