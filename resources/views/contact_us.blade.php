            ...
            <div class="row mt-3">
                <div data-aos="fade-up" class="col-lg-6 ">
                    <div class="info-box mb-4">
                        <i>
                            <img src="{{ url('/images/icons/address.png') }}" alt="address" height="24" width="24"
                ...
                <div data-aos="fade-up" data-aos-delay="100" class="col-lg-3 col-md-6 ">
                    <div class="info-box mb-4">
                        <i>
                            <img src="{{ url('/images/icons/message.png') }}" alt="email" height="24" width="24"
                ...
                <div data-aos="fade-up" data-aos-delay="200" class="col-lg-3 col-md-6  ">
                    <div class="info-box mb-4">
                        <i>
                            <img src="{{ url('/images/icons/telephone.png') }}" alt="phone" height="24" width="24"
