...
<body>
    ...
    <p> Dear Mr/Mrs/Miss {{ auth()->user()->hyacademy->name }},</p>
    ...
    <p>
        <b>Full Name</b>: {{ auth()->user()->hyacademy->name }} <br>
        <b>Admission Number:</b> {{ auth()->user()->hyacademy->admission_no }} <br>
        <b>Email:</b> {{ auth()->user()->email }} <br>
        <b>Phone:</b> {{ auth()->user()->hyacademy->phone }}
    </p>
